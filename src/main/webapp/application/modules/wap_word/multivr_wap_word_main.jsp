...
<div class="rightSide">
    ...
    <div class="content" id="main-content">
    	<div class="sear" id="query_form"> 
            ...
            <label>类型 :
                <select id="query_vrid" name="vrid" size="15" multiple="multiple" style="width: 160px">
            		<option></option>
         	    </select>
         	</label>
<!--             <label>聚合 :
            ...
            <label>pagetype:	
            	<select id="query_pagetype" name="pagetype"  size="15" multiple="multiple" style="width: 160px">
            	<option></option>
         	    </select>
            </label>
            <label>位置 :
            ...
            <label>clickid:<input type="text" size="8" id="query_linkid" name="linkid"/>
            </label>
        ...
        <div class="toolBar">&nbsp;
            <input type="button" value="上传查询词" class="leadingIn" onclick="importInfo();"/> 
        	<input type="button" value="导出" class="leadingInBeen" onclick="exportListIn('wap_word')"/>
        </div>
...
<!-- 弹窗定义 -->
	...
	<!-- 导入弹窗-->
	<div id="importDialog" title="上传查询词"></div>
...
<script type="text/javascript" src="<%=templatePath%>js/wap_word/multivr_wap_word_main.js"></script>
