...
<div class="rightSide">
    ...
    <div class="content" id="main-content">
    	<div class="sear" id="query_form"> 
    		...
    		<label>类型 :
                <select id="query_type" name="type" size="15" multiple="multiple" style="width: 180px">
            		<option></option>
         	    </select>
         	</label>
         	<label>clickid:	
            	<select id="query_clickid" name="clickid" size="1" multiple="multiple" style="width: 80px">
             	  <option value=''>--请选择--</option>
         	    </select>
            </label>
        	<label>&nbsp;时间-从：<input type="text" size="15" id="query_startTime" name="startTime"/></label>
            <label>位置 :
            ...
            <label>查询词:<input type="text" size="15" id="query_keyword" name="keyword"/></label>
            <br/>
