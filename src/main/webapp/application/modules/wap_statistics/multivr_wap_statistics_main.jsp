...
<!--             <label>聚合 :
        ...
        <div class="toolBar">&nbsp;
        	<input type="button" value="导出" class="leadingInBeen" onclick="exportListIn('wap_statistics')"/>
        </div>
...
<script type="text/javascript" src="<%=templatePath%>js/wap_statistics/multivr_wap_statistics_main.js"></script>
